# Apple Satışları üzrə Power BI Dashboard-u

Apple məhsullarının (iPhone, Mac, iPad, Wearables) region və kateqoriya üzrə satışını analiz edən 3 səhifəli Power BI dashboard-u.
...
![Satış Analizi](Ekran%20Resmi%202026-08-01%2001.05.21.png)
...
- Data modelləşdirmə (Apple_Gəlir, Apple_Məhsul, Apple_Region, Calendar cədvəlləri)
- DAX düsturları ilə hesablamalar (MoM%, YoY%, top N analizi)
- İnteraktiv slicerlər və xəritə vizualı

## Fayl
- `Layihe power bi.pbix` — tam dashboard faylı (Power BI Desktop ilə açıla bilər)
